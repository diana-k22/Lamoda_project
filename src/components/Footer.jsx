    ...
    return(
        <div className='footer-wrapper'>
            ...
            <div className='footer-item'>
                ...
                <div className='footer-icon'>
                <FontAwesomeIcon icon="fa-brands fa-cc-mastercard" className='footer-icon__card'/>
                ...
                <a className='footer-card__text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem a possimus, impedit perferendis</a>
